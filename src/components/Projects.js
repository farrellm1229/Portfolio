              ...
              <div className={isVisible ? "animate__animated animate__fadeIn": ""}>
                ...
                <Tab.Container id="projects-tabs" defaultActiveKey="first">
                  <Nav variant="pills" className="nav-pills mb-5 justify-content-center align-items-center" id="pills-tab">
                    ...
                    <Nav.Item>
                      <Nav.Link eventKey="second">Client Application</Nav.Link>
                    </Nav.Item>
                    <Nav.Item>
      ...
      <img align = "right" id="cover" src={sonic4} alt="" />
                    ...
                    <Tab.Pane eventKey="third">
                      ...
                      <p>I created a fully functional compiler from scratch in Java, that took in a modified version of the programming language "C" and output 6502 OpCodes. 
                        ...
                        <br></br><br></br> The Classy Compiler was designed to go through four stages: <strong>Lexical Analysis, Parsing, Semantic Analysis, and Code Generation</strong>. 
...
<img class = "centerPic1" src={compiler9}></img>
                    ...
                    <p>
                    <img class = "centerPic1" src={compiler8}></img>

                    
</p>
                    <p>

This is the Operating System I used to run the generated code. If the input program passed all four stages with 0 errors, the OS would return the correct result!
<br></br>
