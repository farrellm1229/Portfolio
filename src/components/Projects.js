    ...
    <section className="project" id="projects">
      ...
      <img id="cover" src={sonic4} alt="" />
                    ...
                    <p>
                      ...
                      However, even their best efforts were no match to the relentless community I had formed. 
                      
                      <br></br><br></br>I would do whatever it took to revert their attempts, including going into the app files and altering the code. My domination continued to reign for two years, with multiple devices running my programs 24/7, until the developers of the game, "EA Sports", finally figured out how to remove this ability for "bots" to function. 
